        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-10 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-xs font-medium text-muted-foreground mb-6">
              ...
              Étudiante • Développeuse Web • Créatrice
            </div>
          ...
          >
            <div className="absolute -inset-6 bg-gradient-to-br from-pink-500/40 via-fuchsia-500/30 to-blue-500/40 rounded-[2rem] blur-3xl animate-pulse-glow" />
            <div className="relative overflow-hidden rounded-[2rem] glow-border shadow-elegant animate-float">
              <img
                src={butterfliesImg}
                alt="Papillons lumineux roses et bleus"
                width={1024}
                height={1024}
